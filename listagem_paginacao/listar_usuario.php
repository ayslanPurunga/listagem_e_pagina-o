...
echo '<nav aria-label="paginacao">';
  echo '<ul class="pagination">';
   ...
   echo '<li class="page-item active">';
    ...
    echo '<li class="page-item">';
        echo "<span class='page-link'><a href='#' onclick='listar_usuario($quantidade_pg, $qnt_result_pg)'>Ultima</a>";
    echo '</li>';
  echo '</ul>';
echo '</nav>';

    }else{
echo "<div class='alert alert-danger' role='alert'>Nenhum usuario encontrado!</div>";
    }
